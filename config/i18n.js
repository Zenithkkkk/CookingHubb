const TRANSLATIONS = {
  en: {
    home: {
      ...
      heroTitle: 'What do you want to cook today?',
      heroSubtitle: 'Discover recipes from people around the world',
      centerBrand: 'Smart CookingHub',
      explore: 'Explore recipes',
      trendingTitle: 'Trending now',
      viewAll: 'View all',
      emptyFeatured: 'No recipes yet. Be the first to share one!',
      tileRecipes: 'Recipes',
      tileRecipesDesc: 'Browse every dish in the kitchen',
      tileTags: 'Discover Tags',
      tileTagsDesc: 'Find recipes by flavor and style',
      tileShare: 'Share a Recipe',
      tileShareDesc: 'Publish your own cooking story',
      tileLeaderboard: 'Leaderboard',
      tileLeaderboardDesc: 'See what’s popular right now',
      tileFridge: 'My Fridge',
      tileFridgeDesc: 'Cook with what you already have',
      loginPromptTitle: 'Sign in required',
      loginPromptFridge: "You're not logged in yet. Please log in to use My Fridge!",
      loginPromptShare: "You're not logged in yet. Please log in to share a recipe!"
    },
    nav: {
      home: 'Home',
      recipes: 'Recipes',
    ...
    leaderboard: {
      ...
      ratingsSubtitle: 'This ranking is sorted by average recipe rating from highest to lowest. Unrated recipes appear at the end.',
    ...
    tags: {
      ...
      matchAnyHint: 'Matching recipes with any of the selected tags',
    ...
    comments: {
      ...
      reply: 'Reply',
      cancelReply: 'Cancel',
      replyToBanner: 'Replying to @{{username}}',
      replyToLabel: 'Reply to @{{username}}',
    ...
    admin: {
      ...
      usersSubtitle: 'View all registered users. You can grant or revoke admin access.',
  ...
  de: {
    home: {
      hello: 'Hello, recipe app',
      heroTitle: 'Was möchtest du heute kochen?',
      heroSubtitle: 'Entdecke Rezepte von Menschen aus aller Welt',
      centerBrand: 'Smart CookingHub',
      explore: 'Rezepte entdecken',
      trendingTitle: 'Gerade beliebt',
      viewAll: 'Alle ansehen',
      emptyFeatured: 'Noch keine Rezepte. Teile das erste!',
      tileRecipes: 'Rezepte',
      tileRecipesDesc: 'Stöbere durch alle Gerichte',
      tileTags: 'Tags entdecken',
      tileTagsDesc: 'Finde Rezepte nach Stil und Geschmack',
      tileShare: 'Rezept teilen',
      tileShareDesc: 'Veröffentliche deine Kochgeschichte',
      tileLeaderboard: 'Rangliste',
      tileLeaderboardDesc: 'Sieh, was gerade angesagt ist',
      tileFridge: 'Mein Kühlschrank',
      tileFridgeDesc: 'Koche mit dem, was du hast',
      loginPromptTitle: 'Anmeldung erforderlich',
      loginPromptFridge: 'Du bist noch nicht angemeldet. Bitte melde dich an, um den Kühlschrank zu nutzen!',
      loginPromptShare: 'Du bist noch nicht angemeldet. Bitte melde dich an, um ein Rezept zu teilen!'
    },
    nav: {
      home: 'Startseite',
      recipes: 'Rezepte',
    ...
    leaderboard: {
      ...
      tabRatings: 'Bewertungs-Rangliste',
      ...
      ratingsSubtitle: 'Diese Rangliste ist nach der durchschnittlichen Bewertung sortiert (höchste zuerst). Unbewertete Rezepte stehen am Ende.',
    ...
    tags: {
      ...
      matchAnyHint: 'Rezepte, die mindestens eines der ausgewählten Tags enthalten',
    ...
    comments: {
      ...
      replyToBanner: 'Antwort an @{{username}}',
      replyToLabel: 'Antwort an @{{username}}',
      ...
      expandReplies: '{{count}} Antworten anzeigen',
      collapseReplies: 'Einklappen',
    ...
    admin: {
      ...
      usersTitle: 'Alle Benutzer',
      usersSubtitle: 'Alle registrierten Benutzer anzeigen. Du kannst Admin-Rechte vergeben oder entziehen.',
  ...
  es: {
    home: {
      hello: 'Hello, recipe app',
      heroTitle: '¿Qué quieres cocinar hoy?',
      heroSubtitle: 'Descubre recetas de personas de todo el mundo',
      centerBrand: 'Smart CookingHub',
      explore: 'Explorar recetas',
      trendingTitle: 'Tendencias ahora',
      viewAll: 'Ver todas',
      emptyFeatured: 'Aún no hay recetas. ¡Sé el primero en compartir!',
      tileRecipes: 'Recetas',
      tileRecipesDesc: 'Explora todos los platos',
      tileTags: 'Descubrir etiquetas',
      tileTagsDesc: 'Encuentra recetas por sabor y estilo',
      tileShare: 'Compartir receta',
      tileShareDesc: 'Publica tu propia historia culinaria',
      tileLeaderboard: 'Ranking',
      tileLeaderboardDesc: 'Mira lo más popular ahora',
      tileFridge: 'Mi nevera',
      tileFridgeDesc: 'Cocina con lo que ya tienes',
      loginPromptTitle: 'Inicio de sesión requerido',
      loginPromptFridge: 'Aún no has iniciado sesión. ¡Inicia sesión para usar Mi nevera!',
      loginPromptShare: 'Aún no has iniciado sesión. ¡Inicia sesión para compartir una receta!'
    },
    nav: {
      home: 'Inicio',
      recipes: 'Recetas',
    ...
    leaderboard: {
      ...
      tabRatings: 'Ranking por puntuación',
      ...
      ratingsSubtitle: 'Este ranking se ordena por la puntuación media, de mayor a menor. Las recetas sin puntuación aparecen al final.',
    ...
    tags: {
      ...
      matchAnyHint: 'Recetas que coinciden con cualquiera de las etiquetas seleccionadas',
    ...
    comments: {
      ...
      replyToBanner: 'Respondiendo a @{{username}}',
      replyToLabel: 'Respuesta a @{{username}}',
      ...
      expandReplies: 'Ver {{count}} respuestas',
      collapseReplies: 'Ocultar',
    ...
    admin: {
      ...
      usersSubtitle: 'Ver todos los usuarios registrados. Puedes otorgar o quitar acceso de administrador.',
  ...
  zh: {
    home: {
      hello: 'Hello, recipe app',
      heroTitle: '今天想做什么菜？',
      heroSubtitle: '发现来自世界各地的美味食谱',
      centerBrand: 'Smart CookingHub',
      explore: '探索食谱',
      trendingTitle: '大家都在做',
      viewAll: '查看全部',
      emptyFeatured: '还没有食谱，来发布第一道吧！',
      tileRecipes: '食谱',
      tileRecipesDesc: '浏览厨房里的每一道菜',
      tileTags: '发现标签',
      tileTagsDesc: '按风味与风格找灵感',
      tileShare: '分享食谱',
      tileShareDesc: '发布你的烹饪故事',
      tileLeaderboard: '排行榜',
      tileLeaderboardDesc: '看看此刻最受欢迎的菜',
      tileFridge: '我的冰箱',
      tileFridgeDesc: '用已有食材来做菜',
      loginPromptTitle: '需要登录',
      loginPromptFridge: '你还没有登录。请先登录后再使用我的冰箱！',
      loginPromptShare: '你还没有登录。请先登录后再分享食谱！'
    },
    nav: {
      home: '首页',
      recipes: '食谱',
    ...
    comments: {
      ...
      reply: '回复',
      cancelReply: '取消',
      replyToBanner: '回复 @{{username}}',
      replyToLabel: '回复 @{{username}}',
      deleted: '该评论已删除。',
      unknownUser: '未知用户',
      loginToLeave: '以发表评论。',
      loginToReply: '登录后回复',
    ...
    admin: {
      manageUsers: '用户管理',
      usersTitle: '所有用户',
      usersSubtitle: '查看全部注册用户，可为普通用户授予或取消管理员权限。',
